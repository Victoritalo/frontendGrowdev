...
if(isNaN(valorA + valorB + valorC)){
    ...
    if(valorA === valorB && valorA === valorC){
        ...
        document.write(`O triângulo equilátero é um tipo de triângulo que possui os três lados congruentes (mesma medida).`)
    }
    else{
        if(valorA === valorB || valorA === valorC || valorB === valorC){
            alert(`Triangulo isósceles!`)
            document.write(`Triângulo isósceles é um polígono que apresenta três lados, sendo dois deles congruentes (mesma medida).`)
        }
        else if(valorA != valorB && valorB != valorC && valorA != valorC){
            alert(`Triangulo escaleno!`)
            document.write(`Triângulo escaleno é o polígono que possui três lados com diferentes medidas e três ângulos diferentes.`)
        }
    }
}
else{
